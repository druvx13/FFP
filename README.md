...
### Using FFP License for Your Project

1. **Copy the License**: Download the full [LICENSE](LICENSE) file and place it in your project's root directory.

2. **Add License Notice**: Include this notice in your README and/or source file headers:
...
### Using FFP Licensed Works

When using works licensed under FFP:

- ✅ You can use, modify, and distribute the work
- ✅ You can use it for commercial purposes
- ✅ You must include the license and copyright notices
- ✅ You must not remove attribution or license notices
...
Show that your project uses the FFP License with these badges:
...
- **GitHub**: [druvx13/FFP](https://github.com/druvx13/FFP)
- **Issues**: Report issues or ask questions via [GitHub Issues](https://github.com/druvx13/FFP/issues)
- **Discussions**: Join the conversation in [GitHub Discussions](https://github.com/druvx13/FFP/discussions)
